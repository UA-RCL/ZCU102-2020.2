; ModuleID = '/mnt/data/Xilinx_Workspace/Vivado/ZCU102_10ffts/HLS_accel/Conv2D/conv_filter_prj/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"class.hls::stream.2" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6 }
%struct.ap_uint = type { %struct.ap_int_base }
%struct.ap_uint.3 = type { %struct.ap_int_base.4 }
%struct.ap_int_base.4 = type { %struct.ssdm_int.5 }
%struct.ssdm_int.5 = type { i4 }
%struct.ap_uint.6 = type { %struct.ap_int_base.7 }
%struct.ap_int_base.7 = type { %struct.ssdm_int.8 }
%struct.ssdm_int.8 = type { i1 }

; Function Attrs: noinline
define void @apatb_Filter2DKernel_ir(float* %coeffs, float %factor, i16 %bias, i16 %width, i16 %height, i16 %stride, %struct.ap_int_base* %input_stream, %"class.hls::stream.2"* %output_stream) local_unnamed_addr #0 {
entry:
  %coeffs_copy = alloca [121 x float], align 512
  %input_stream_copy1 = alloca %struct.ap_int_base, align 512
  %output_stream_copy = alloca %"class.hls::stream.2", align 512
  %0 = bitcast float* %coeffs to [121 x float]*
  call fastcc void @copy_in([121 x float]* %0, [121 x float]* nonnull align 512 %coeffs_copy, %struct.ap_int_base* %input_stream, %struct.ap_int_base* nonnull align 512 %input_stream_copy1, %"class.hls::stream.2"* %output_stream, %"class.hls::stream.2"* nonnull align 512 %output_stream_copy)
  %1 = getelementptr inbounds [121 x float], [121 x float]* %coeffs_copy, i32 0, i32 0
  call void @apatb_Filter2DKernel_hw(float* %1, float %factor, i16 %bias, i16 %width, i16 %height, i16 %stride, %struct.ap_int_base* %input_stream_copy1, %"class.hls::stream.2"* %output_stream_copy)
  call fastcc void @copy_out([121 x float]* %0, [121 x float]* nonnull align 512 %coeffs_copy, %struct.ap_int_base* %input_stream, %struct.ap_int_base* nonnull align 512 %input_stream_copy1, %"class.hls::stream.2"* %output_stream, %"class.hls::stream.2"* nonnull align 512 %output_stream_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([121 x float]* readonly, [121 x float]* noalias align 512, %struct.ap_int_base*, %struct.ap_int_base* noalias align 512, %"class.hls::stream.2"*, %"class.hls::stream.2"* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a121f32([121 x float]* align 512 %1, [121 x float]* %0)
  call fastcc void @onebyonecpy_hls.p0struct.ap_int_base(%struct.ap_int_base* align 512 %3, %struct.ap_int_base* %2)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* align 512 %5, %"class.hls::stream.2"* %4)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a121f32([121 x float]* noalias align 512, [121 x float]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [121 x float]* %0, null
  %3 = icmp eq [121 x float]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr.gep1 = getelementptr [121 x float], [121 x float]* %0, i64 0, i64 %for.loop.idx3
  %5 = bitcast float* %dst.addr.gep1 to i8*
  %src.addr.gep2 = getelementptr [121 x float], [121 x float]* %1, i64 0, i64 %for.loop.idx3
  %6 = bitcast float* %src.addr.gep2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 %6, i64 4, i1 false)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx3, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 121
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0struct.ap_int_base(%struct.ap_int_base* noalias align 512, %struct.ap_int_base* noalias) unnamed_addr #4 {
entry:
  %2 = icmp eq %struct.ap_int_base* %0, null
  %3 = icmp eq %struct.ap_int_base* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy

copy:                                             ; preds = %entry
  %5 = bitcast %struct.ap_int_base* %1 to i8*
  %6 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %6, label %7, label %8

; <label>:7:                                      ; preds = %copy
  call fastcc void @streamcpy_hls.p0struct.ap_int_base(%struct.ap_int_base* nonnull align 512 %0, %struct.ap_int_base* nonnull %1)
  br label %ret

; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %struct.ap_int_base, %struct.ap_int_base* %1, i32 0, i32 0
  %.01 = getelementptr %struct.ap_int_base, %struct.ap_int_base* %0, i32 0, i32 0
...
; <label>:11:                                     ; preds = %8
  %12 = bitcast %struct.ap_int_base* %0 to i8*
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* noalias align 512, %"class.hls::stream.2"* noalias) unnamed_addr #4 {
entry:
  %2 = icmp eq %"class.hls::stream.2"* %0, null
  %3 = icmp eq %"class.hls::stream.2"* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy

copy:                                             ; preds = %entry
  %5 = bitcast %"class.hls::stream.2"* %1 to i8*
  %6 = call i1 @fpga_fifo_exist_12(i8* %5)
  br i1 %6, label %7, label %8

; <label>:7:                                      ; preds = %copy
  call fastcc void @"streamcpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* nonnull align 512 %0, %"class.hls::stream.2"* nonnull %1)
  br label %ret

; <label>:8:                                      ; preds = %copy
  %.0.02 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 0
  %.01.03 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 0
  %9 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %9, label %10, label %11
...
; <label>:11:                                     ; preds = %8
  %.0.0.04 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 0, i32 0
  %.01.0.05 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 0, i32 0
...
; <label>:14:                                     ; preds = %11
  %.0.0.0.06 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 0, i32 0, i32 0
  %.01.0.0.07 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 0, i32 0, i32 0
  %15 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %15, label %16, label %17

; <label>:16:                                     ; preds = %14
  call fastcc void @"streamcpy_hls.p0class.hls::stream.0"(%"class.hls::stream.0"* align 512 %.01.0.0.07, %"class.hls::stream.0"* %.0.0.0.06)
  br label %19

; <label>:17:                                     ; preds = %14
  %18 = bitcast %"class.hls::stream.2"* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %18, i8* align 1 %5, i64 4, i1 false)
  br label %19

; <label>:19:                                     ; preds = %17, %16, %13, %10
  %.0.110 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 1
  %.01.111 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 1
...
; <label>:23:                                     ; preds = %19
  %.0.1.012 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 1, i32 0
  %.01.1.013 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 1, i32 0
...
; <label>:27:                                     ; preds = %23
  %.0.1.0.014 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 1, i32 0, i32 0
  %.01.1.0.015 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 1, i32 0, i32 0
...
; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep59 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i4* %.01.1.0.0.017.gep59 to i8*
  %.0.1.0.0.016.gep60 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  %.0.218 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 2
  %.01.219 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 2
...
; <label>:38:                                     ; preds = %34
  %.0.2.020 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 2, i32 0
  %.01.2.021 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 2, i32 0
...
; <label>:42:                                     ; preds = %38
  %.0.2.0.022 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 2, i32 0, i32 0
  %.01.2.0.023 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 2, i32 0, i32 0
...
; <label>:46:                                     ; preds = %42
  %.01.2.0.0.025.gep61 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %47 = bitcast i4* %.01.2.0.0.025.gep61 to i8*
  %.0.2.0.0.024.gep62 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  %.0.326 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 3
  %.01.327 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 3
...
; <label>:53:                                     ; preds = %49
  %.0.3.028 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 3, i32 0
  %.01.3.029 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 3, i32 0
...
; <label>:57:                                     ; preds = %53
  %.0.3.0.030 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 3, i32 0, i32 0
  %.01.3.0.031 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 3, i32 0, i32 0
...
; <label>:61:                                     ; preds = %57
  %.01.3.0.0.033.gep63 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %62 = bitcast i1* %.01.3.0.0.033.gep63 to i8*
  %.0.3.0.0.032.gep64 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  %.0.434 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 4
  %.01.435 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 4
...
; <label>:68:                                     ; preds = %64
  %.0.4.036 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 4, i32 0
  %.01.4.037 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 4, i32 0
...
; <label>:72:                                     ; preds = %68
  %.0.4.0.038 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 4, i32 0, i32 0
  %.01.4.0.039 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 4, i32 0, i32 0
...
; <label>:76:                                     ; preds = %72
  %.01.4.0.0.041.gep65 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %77 = bitcast i1* %.01.4.0.0.041.gep65 to i8*
  %.0.4.0.0.040.gep66 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  %.0.542 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 5
  %.01.543 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 5
...
; <label>:83:                                     ; preds = %79
  %.0.5.044 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 5, i32 0
  %.01.5.045 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 5, i32 0
...
; <label>:87:                                     ; preds = %83
  %.0.5.0.046 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 5, i32 0, i32 0
  %.01.5.0.047 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 5, i32 0, i32 0
...
; <label>:91:                                     ; preds = %87
  %.01.5.0.0.049.gep67 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %92 = bitcast i1* %.01.5.0.0.049.gep67 to i8*
  %.0.5.0.0.048.gep68 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  %.0.650 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 6
  %.01.651 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 6
...
; <label>:98:                                     ; preds = %94
  %.0.6.052 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 6, i32 0
  %.01.6.053 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 6, i32 0
...
; <label>:102:                                    ; preds = %98
  %.0.6.0.054 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 6, i32 0, i32 0
  %.01.6.0.055 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 6, i32 0, i32 0
...
; <label>:106:                                    ; preds = %102
  %.01.6.0.0.057.gep69 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %107 = bitcast i1* %.01.6.0.0.057.gep69 to i8*
  %.0.6.0.0.056.gep70 = getelementptr %"class.hls::stream.2", %"class.hls::stream.2"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* noalias nocapture align 512, %"class.hls::stream.2"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([121 x float]*, [121 x float]* noalias readonly align 512, %struct.ap_int_base*, %struct.ap_int_base* noalias align 512, %"class.hls::stream.2"*, %"class.hls::stream.2"* noalias align 512) unnamed_addr #6 {
entry:
  call fastcc void @onebyonecpy_hls.p0a121f32([121 x float]* %0, [121 x float]* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0struct.ap_int_base(%struct.ap_int_base* %2, %struct.ap_int_base* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.2"(%"class.hls::stream.2"* %4, %"class.hls::stream.2"* align 512 %5)
  ret void
}

declare void @apatb_Filter2DKernel_hw(float*, float, i16, i16, i16, i16, %struct.ap_int_base*, %"class.hls::stream.2"*)

define void @Filter2DKernel_hw_stub_wrapper(float*, float, i16, i16, i16, i16, %struct.ap_int_base*, %"class.hls::stream.2"*) #7 {
entry:
  %8 = bitcast float* %0 to [121 x float]*
  call void @copy_out([121 x float]* null, [121 x float]* %8, %struct.ap_int_base* null, %struct.ap_int_base* %6, %"class.hls::stream.2"* null, %"class.hls::stream.2"* %7)
  %9 = bitcast [121 x float]* %8 to float*
  call void @Filter2DKernel_hw_stub(float* %9, float %1, i16 %2, i16 %3, i16 %4, i16 %5, %struct.ap_int_base* %6, %"class.hls::stream.2"* %7)
  call void @copy_in([121 x float]* null, [121 x float]* %8, %struct.ap_int_base* null, %struct.ap_int_base* %6, %"class.hls::stream.2"* null, %"class.hls::stream.2"* %7)
  ret void
}

declare void @Filter2DKernel_hw_stub(float*, float, i16, i16, i16, i16, %struct.ap_int_base*, %"class.hls::stream.2"*)
