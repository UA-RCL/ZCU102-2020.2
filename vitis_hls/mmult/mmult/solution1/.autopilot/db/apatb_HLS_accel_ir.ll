; ModuleID = '/mnt/data/Xilinx_Workspace/Vivado/ZCU102_10ffts/HLS_accel/mmult/mmult/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_HLS_accel_ir(%"class.hls::stream"* %INPUT_STREAM, %"class.hls::stream"* %OUTPUT_STREAM) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_HLS_accel_hw(%"class.hls::stream"* %INPUT_STREAM_copy, %"class.hls::stream"* %OUTPUT_STREAM_copy)
...
declare void @apatb_HLS_accel_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @HLS_accel_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @HLS_accel_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @HLS_accel_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
