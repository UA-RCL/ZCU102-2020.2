...
set Library     "hls"
set IPName      "ZIP_HLS_accel"
set Version     "1.0"
set DisplayName "ZIP"
set Revision    "2113197527"
set Description "ZIP"
...
set xo_kernel_name "ZIP_HLS_accel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/mnt/data/Xilinx_Workspace/Vivado/ZCU102_10ffts/HLS_accel/ZIP/ZIP_prj/zip"
set debug_dir "/mnt/data/Xilinx_Workspace/Vivado/ZCU102_10ffts/HLS_accel/ZIP/ZIP_prj/zip/.debug"
set xo_hls_files_dir ""
set hdl_module_list {ZIP_HLS_accel_faddfsub_32ns_32ns_32_11_full_dsp_1
...
ZIP_HLS_accel_ctrl_s_axi
ZIP_HLS_accel_regslice_both
ZIP_HLS_accel_regslice_both
ZIP_HLS_accel_regslice_both
ZIP_HLS_accel_regslice_both
ZIP_HLS_accel_regslice_both
...
## Variables
set Top "ZIP_HLS_accel"
set TopNoPrefix "ZIP_HLS_accel"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl INPUT_STREAM OUTPUT_STREAM"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.333 machine 64 combinational 0 latency 5 II x}
