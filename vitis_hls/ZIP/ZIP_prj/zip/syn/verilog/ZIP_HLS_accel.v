...
(* CORE_GENERATION_INFO="ZIP_HLS_accel_ZIP_HLS_accel,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.606400,HLS_SYN_LAT=2743,HLS_SYN_TPT=none,HLS_SYN_MEM=24,HLS_SYN_DSP=0,HLS_SYN_FF=4193,HLS_SYN_LUT=3097,HLS_VERSION=2020_2}" *)

module ZIP_HLS_accel (
        ap_clk,
        ap_rst_n,
        INPUT_STREAM_TDATA,
        INPUT_STREAM_TVALID,
...
wire   [31:0] size;
wire   [31:0] op;
reg   [31:0] op_read_reg_116;
wire    ap_CS_fsm_state2;
wire   [30:0] empty_fu_111_p1;
reg   [30:0] empty_reg_121;
wire    grp_wrapper_zip_hw_fu_76_ap_start;
wire    grp_wrapper_zip_hw_fu_76_ap_done;
wire    grp_wrapper_zip_hw_fu_76_ap_idle;
wire    grp_wrapper_zip_hw_fu_76_ap_ready;
wire    grp_wrapper_zip_hw_fu_76_INPUT_STREAM_TREADY;
wire   [31:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TDATA;
wire    grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TVALID;
wire    grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TREADY;
wire   [3:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TKEEP;
wire   [3:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TSTRB;
wire   [0:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TUSER;
wire   [0:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TLAST;
wire   [0:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TID;
wire   [0:0] grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TDEST;
reg    grp_wrapper_zip_hw_fu_76_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_wrapper_zip_hw_fu_76_ap_start_reg = 1'b0;
end
...
ZIP_HLS_accel_wrapper_zip_hw grp_wrapper_zip_hw_fu_76(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_wrapper_zip_hw_fu_76_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_wrapper_zip_hw_fu_76_ap_start_reg <= 1'b1;
        end else if ((grp_wrapper_zip_hw_fu_76_ap_ready == 1'b1)) begin
            grp_wrapper_zip_hw_fu_76_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_wrapper_zip_hw_fu_76_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign empty_fu_111_p1 = size[30:0];

assign grp_wrapper_zip_hw_fu_76_OUTPUT_STREAM_TREADY = (ap_CS_fsm_state3 & OUTPUT_STREAM_TREADY_int_regslice);

assign grp_wrapper_zip_hw_fu_76_ap_start = grp_wrapper_zip_hw_fu_76_ap_start_reg;

endmodule //ZIP_HLS_accel
