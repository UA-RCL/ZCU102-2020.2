...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 34 \
			corename ZIP_HLS_accel_ctrl_axilite \
			name ZIP_HLS_accel_ctrl_s_axi \
			ports {$port_ctrl} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ZIP_HLS_accel_ctrl_s_axi
}
...
# RegSlice definition:
set ID 49
set RegSliceName ZIP_HLS_accel_regslice_both
set RegSliceInstName ZIP_HLS_accel_regslice_both_U
set CoreName ap_simcore_ZIP_HLS_accel_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
