; ModuleID = '/mnt/data/Xilinx_Workspace/Vivado/ZCU102_10ffts/HLS_accel/ZIP/ZIP_prj/zip/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_ZIP_HLS_accel_ir(%"class.hls::stream"* %INPUT_STREAM, %"class.hls::stream"* %OUTPUT_STREAM, i32 %size, i32 %op) local_unnamed_addr #0 {
entry:
  %INPUT_STREAM_copy = alloca %"class.hls::stream", align 512
  %OUTPUT_STREAM_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %INPUT_STREAM, %"class.hls::stream"* nonnull align 512 %INPUT_STREAM_copy, %"class.hls::stream"* %OUTPUT_STREAM, %"class.hls::stream"* nonnull align 512 %OUTPUT_STREAM_copy)
  call void @apatb_ZIP_HLS_accel_hw(%"class.hls::stream"* %INPUT_STREAM_copy, %"class.hls::stream"* %OUTPUT_STREAM_copy, i32 %size, i32 %op)
  call fastcc void @copy_out(%"class.hls::stream"* %INPUT_STREAM, %"class.hls::stream"* nonnull align 512 %INPUT_STREAM_copy, %"class.hls::stream"* %OUTPUT_STREAM, %"class.hls::stream"* nonnull align 512 %OUTPUT_STREAM_copy)
  ret void
}
...
declare void @apatb_ZIP_HLS_accel_hw(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32)

define void @ZIP_HLS_accel_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @ZIP_HLS_accel_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i32 %2, i32 %3)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @ZIP_HLS_accel_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32)
