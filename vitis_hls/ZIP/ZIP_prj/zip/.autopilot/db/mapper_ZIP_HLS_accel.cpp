...
extern "C" void ZIP_HLS_accel(__cosim_sC__*, __cosim_sC__*, int, int);
extern "C" void apatb_ZIP_HLS_accel_hw(volatile void * __xlx_apatb_param_INPUT_STREAM, volatile void * __xlx_apatb_param_OUTPUT_STREAM, int __xlx_apatb_param_size, int __xlx_apatb_param_op) {
  ...
  // DUT call
  ZIP_HLS_accel(__xlx_INPUT_STREAM_input_buffer, __xlx_OUTPUT_STREAM_input_buffer, __xlx_apatb_param_size, __xlx_apatb_param_op);
