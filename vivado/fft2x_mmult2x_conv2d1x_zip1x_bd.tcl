...
proc create_root_design { parentCell } {
  ...
  # Create instance: mmult_0_dma_smartconnect, and set properties
  set mmult_0_dma_smartconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 mmult_0_dma_smartconnect ]
  set_property -dict [ list \
   CONFIG.NUM_SI {2} \
  ...
  # Create instance: mmult_1_dma_smartconnect, and set properties
  set mmult_1_dma_smartconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 mmult_1_dma_smartconnect ]
  set_property -dict [ list \
   CONFIG.NUM_SI {2} \
 ] $mmult_1_dma_smartconnect
  ...
  connect_bd_intf_net -intf_net fft_1_dma_smartconnect_M00_AXI [get_bd_intf_pins fft_1_dma_smartconnect/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins config_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins config_interconnect/S01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins config_interconnect/ARESETN] [get_bd_pins config_interconnect/M00_ARESETN] [get_bd_pins config_interconnect/M01_ARESETN] [get_bd_pins config_interconnect/M02_ARESETN] [get_bd_pins config_interconnect/M03_ARESETN] [get_bd_pins config_interconnect/M04_ARESETN] [get_bd_pins config_interconnect/M05_ARESETN] [get_bd_pins config_interconnect/M06_ARESETN] [get_bd_pins config_interconnect/M07_ARESETN] [get_bd_pins config_interconnect/S00_ARESETN] [get_bd_pins config_interconnect/S01_ARESETN] [get_bd_pins fft_0_dma_smartconnect/aresetn] [get_bd_pins fft_1_dma_smartconnect/aresetn] [get_bd_pins mmult_0_dma_smartconnect/aresetn] [get_bd_pins mmult_1_dma_smartconnect/aresetn] [get_bd_pins rst_ps8_0_99M/interconnect_aresetn]
  ...
  connect_bd_net -net fft_0_dma_mm2s_introut [get_bd_pins fft_0_dma/mm2s_introut] [get_bd_pins irq_concat/In0]
  connect_bd_net -net fft_0_dma_s2mm_introut [get_bd_pins fft_0_dma/s2mm_introut] [get_bd_pins irq_concat/In1]
  ...
  connect_bd_net -net fft_1_dma_mm2s_introut [get_bd_pins fft_1_dma/mm2s_introut] [get_bd_pins irq_concat/In2]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins Conv2D_0/ap_rst_n] [get_bd_pins ZIP_0/ap_rst_n] [get_bd_pins ZIP_0_dma/axi_resetn] [get_bd_pins config_interconnect/M08_ARESETN] [get_bd_pins config_interconnect/M09_ARESETN] [get_bd_pins config_interconnect/M10_ARESETN] [get_bd_pins config_interconnect/M11_ARESETN] [get_bd_pins conv2D_0_dma/axi_resetn] [get_bd_pins fft_0_config_gpio/s_axi_aresetn] [get_bd_pins fft_0_resetn_gpio/s_axi_aresetn] [get_bd_pins fft_0_resetn_logic/Op1] [get_bd_pins fft_1_config_gpio/s_axi_aresetn] [get_bd_pins fft_1_resetn_gpio/s_axi_aresetn] [get_bd_pins fft_1_resetn_logic/Op1] [get_bd_pins mmult_0/ap_rst_n] [get_bd_pins mmult_0_dma/axi_resetn] [get_bd_pins mmult_1/ap_rst_n] [get_bd_pins mmult_1_dma/axi_resetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces fft_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_PCIE_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_PCIE_LOW] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_PCIE_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_PCIE_LOW] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_PCIE_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces mmult_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_PCIE_LOW] -force
  ...
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces conv2D_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces conv2D_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mmult_1_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
